...
export const STATIC_I18N_KEYS = [
  // Channel-level upstream asynchronous task validation messages.
  'Path is required',
  'Path is too long',
  'Use a restricted GJSON path',
  'Status strings must not be empty',
  ...
  'A profile can contain at most 128 models',
  'Select at least one operation',
  'A profile can contain at most three operations',
  'At least one succeeded value is required',
  'At least one failed value is required',
  'At least one profile is required',
  'At most 32 profiles are allowed',
  'Task ID path is required',
  'Polling path is required',
  'Status path is required',
  'Result URL path is required',
  'Search tasks',
  'Start date',
  'End date',
