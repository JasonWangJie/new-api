...
func SetApiRouter(router *gin.Engine) {
	...
	setImageManagementRouter(apiRouter)
	...
	imageOptions.PUT("/policy", middleware.RequirePermission(authz.ImageConfigManage), controller.SaveImagePolicy)
	imageOptions.PUT("/pool", middleware.RequirePermission(authz.ImageConfigManage), controller.SaveImageChannelPool)
	imageOptions.POST("/storage", middleware.RequirePermission(authz.ImageConfigManage), controller.SaveImageStorage)
	imageOptions.POST("/storage/:profile_id/test", middleware.RequirePermission(authz.ImageConfigManage), controller.TestImageStorage)
	apiRouter.GET("/token/:id/image-platform-groups", middleware.DisableCache(), middleware.UserAuth(), controller.GetTokenImageMappings)
	apiRouter.PATCH("/token/:id/image-platform-groups", middleware.DisableCache(), middleware.UserAuth(), controller.UpdateTokenImageMappings)
	apiRouter.GET("/user/image-workbench/capabilities/:token_id", middleware.UserAuth(), middleware.DisableCache(), controller.GetImageWorkbenchCapabilities)
	userImageTasks := apiRouter.Group("/user/async-image-tasks", middleware.UserAuth(), middleware.DisableCache())
	userImageTasks.GET("", func(c *gin.Context) { controller.ListImageTasks(c, false) })
	userImageTasks.GET("/:task_id", func(c *gin.Context) { controller.GetImageTask(c, false) })
	userImageTasks.GET("/:task_id/results/:image_index/view", func(c *gin.Context) { controller.ViewImageTaskResult(c, false) })
	adminImageTasks := apiRouter.Group("/admin/async-image-tasks", middleware.AdminAuth(), middleware.DisableCache())
	adminImageTasks.GET("", middleware.RequirePermission(authz.AsyncImageTaskRead), func(c *gin.Context) { controller.ListImageTasks(c, true) })
	adminImageTasks.GET("/:task_id", middleware.RequirePermission(authz.AsyncImageTaskRead), func(c *gin.Context) { controller.GetImageTask(c, true) })
	adminImageTasks.GET("/:task_id/results/:image_index/view", middleware.RequirePermission(authz.AsyncImageTaskRead), func(c *gin.Context) { controller.ViewImageTaskResult(c, true) })
	adminImageTasks.POST("/:task_id/resume", middleware.RequirePermission(authz.AsyncImageTaskManage), func(c *gin.Context) { controller.ManageImageTask(c, "resume") })
	adminImageTasks.POST("/:task_id/terminate", middleware.RequirePermission(authz.AsyncImageTaskManage), func(c *gin.Context) { controller.ManageImageTask(c, "terminate") })
	adminImageTasks.POST("/batch-terminate", middleware.RequirePermission(authz.AsyncImageTaskManage), controller.BatchTerminateImageTasks)
	userMediaTasks := apiRouter.Group("/user/media-tasks", middleware.UserAuth(), middleware.DisableCache())
	userMediaTasks.GET("", func(c *gin.Context) { controller.ListMediaTasks(c, false) })
	userMediaTasks.GET("/:task_id", func(c *gin.Context) { controller.GetMediaTask(c, false) })
	userMediaTasks.POST("/:task_id/resume", func(c *gin.Context) { controller.ManageMediaTask(c, false, "resume") })
	userMediaTasks.POST("/:task_id/terminate", func(c *gin.Context) { controller.ManageMediaTask(c, false, "terminate") })
	adminMediaTasks := apiRouter.Group("/admin/media-tasks", middleware.AdminAuth(), middleware.DisableCache())
	adminMediaTasks.GET("", middleware.RequirePermission(authz.AsyncImageTaskRead), func(c *gin.Context) { controller.ListMediaTasks(c, true) })
	adminMediaTasks.GET("/:task_id", middleware.RequirePermission(authz.AsyncImageTaskRead), func(c *gin.Context) { controller.GetMediaTask(c, true) })
	adminMediaTasks.POST("/:task_id/resume", middleware.RequirePermission(authz.AsyncImageTaskManage), func(c *gin.Context) { controller.ManageMediaTask(c, true, "resume") })
	adminMediaTasks.POST("/:task_id/terminate", middleware.RequirePermission(authz.AsyncImageTaskManage), func(c *gin.Context) { controller.ManageMediaTask(c, true, "terminate") })
